...
public class EditBloodTestTable {
    ...
    public String bloodTestToJSON(BloodTest bt) {
     ...
     public BloodTest databaseToBloodTest(String amka,String date) throws SQLException, ClassNotFoundException{
        ...
        try {
            ...
            System.err.println("Problem while searching for amka: " + amka + " and date: " + date + " from databaseToBloodTest! ");
    ...
    public ArrayList<BloodTest> databaseToBloodTests(String amka) throws SQLException, ClassNotFoundException {
        Connection con = DB_Connection.getConnection();
        Statement stmt = con.createStatement();
        ArrayList<BloodTest> randevouz = new ArrayList<>();
        ResultSet rs;
        try {
            ...
            con.close();
            randevouz.sort(
                    new Comparator<BloodTest>() {
                @Override
                        public int compare(BloodTest r1, BloodTest r2) {
                    try {
                        Date firstdate = new SimpleDateFormat("yyyy-MM-dd").parse(r1.getTest_date());
                        Date seconddate = new SimpleDateFormat("yyyy-MM-dd").parse(r2.getTest_date());
            ...
            System.err.println("Exception in databaseToBloodTests amka: " + amka + "! ");
            System.err.println(e.getMessage());
        }
        con.close();
        return null;
